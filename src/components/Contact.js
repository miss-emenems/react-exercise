...
class Contact extends Component {
	...
	render () {
		const formNotSubmited = !this.state.thankYou;
...

				{
					formNotSubmited ?
						...
						<div className="contact__form">
							...
							<p>Please enter your contact details, so the dealership representative can get in touch to arrange a test
							   drive.</p>
							<form action="" className="form">
								...
								<div className="form__section">
									<fieldset className="section--purchase-time">
								...
								<div className="form__section section--contact-preferences">
									...
									<p>Please select which communication channels you would like us to use to keep you informed of future
									   news and events.</p>
									<fieldset>
								...
								<div className="form__section section--form-submition">
									...
									<div className="form__field field field--checkbox-privacy">
										...
										<label htmlFor="checkboxPrivacyPolicy">I have read and agree to the <a href="#">privacy
										                                                                                policy</a></label>
									</div>
									<button className="btn--full btn--solid-cta"
									        onClick={ this.displayThankYou }
									>
										<span className="btn__label">Send request</span>
									</button>
									<p className="disclaimer">The data you have provided above will be used to contact you and arrange a
									                          test ride for you. We may also use it to ask you about your experience. This
									                          means that we will share the data with our dealers or agents (you can see
									                          our full privacy notice here). In the future, if you would like to hear more
									                          from us about our Products, Services and Offers please tell us by selecting
									                          the relevant options. You will be able to unsubscribe from these services at
									                          any time by unsubscribing directly from the emails or by contacting your
									                          Dealer.</p>
								</div>
							</form>
						</div>
